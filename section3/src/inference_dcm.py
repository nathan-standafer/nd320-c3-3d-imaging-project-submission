...
def get_series_for_inference(path):
    ...
    for sub_path in os.listdir(path):
        print("adding dicoms in directory: ", os.path.join(path, sub_path))
        for dcm in os.listdir(os.path.join(path, sub_path)):
            dicoms.append(pydicom.dcmread(os.path.join(os.path.join(path, sub_path), dcm)))
    ...
    print("Found {} HippoCrop dicoms".format(len(series_for_inference)))
